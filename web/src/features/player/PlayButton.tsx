  ...
  return (
    ...
    >
      {loaded ? (
        ...
        // Nudged right: a centered triangle looks off-center against its own leading edge.
        <svg aria-hidden="true" viewBox="0 0 24 24" className="ml-0.5 size-5 fill-current">
