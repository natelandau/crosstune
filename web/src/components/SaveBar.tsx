...
export function SaveBar({
  ...
  return (
    <div className="bg-base-100 border-base-content/10 fixed inset-x-0 bottom-[calc(var(--dock-height)+env(safe-area-inset-bottom)+var(--player-dock-offset,var(--dock-cap)))] z-10 border-t">
      {error ? (
